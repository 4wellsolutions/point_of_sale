                ...
                <div class="row">
                    ...
                    <div class="col-12 col-md-4 col-lg-4 mb-3">
                        ...
                        <select class="form-select" name="opening_balance_type">
                            <option value="debit"  {{ old('opening_balance_type', $customer->opening_balance_type) === 'debit'  ? 'selected' : '' }}>Debit (Customer owes us)</option>
                            <option value="credit" {{ old('opening_balance_type', $customer->opening_balance_type) === 'credit' ? 'selected' : '' }}>Credit (We owe customer)</option>
                        </select>
                    </div>
