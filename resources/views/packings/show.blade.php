    ...
    <div class="detail-header mb-4">
        <div class="d-flex justify-content-between align-items-start flex-wrap gap-3">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h2 class="mb-1" style="font-weight:700; font-size:1.5rem;">{{ $packing->type }}</h2>
                    <div class="d-flex align-items-center gap-2">
                        <span class="detail-id-badge">{{ $packing->unit_size }}</span>
                    </div>
                </div>
            </div>
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('packings.index') }}" class="btn btn-outline-secondary btn-sm">
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header d-flex align-items-center gap-2">
                    ...
                    <h3 class="card-title mb-0">Packing Information</h3>
                </div>
                    ...
                    <div class="row g-0">
                        <div class="col-sm-6">
                            <div class="detail-row">
                                ...
                                <span class="detail-value">{{ $packing->type }}</span>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="detail-row">
                                <span class="detail-label"><i class="fas fa-ruler"></i> Unit Size</span>
                                <span class="detail-value">{{ $packing->unit_size }}</span>
                            </div>
                        </div>
                        <div class="col-sm-12">
                            <div class="detail-row" style="border-right:none;">
                                <span class="detail-label"><i class="fas fa-align-left"></i> Description</span>
                                <span class="detail-value">{{ $packing->description ?? '—' }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="timeline-item mb-3">
                        ...
                        <p class="mb-0 ps-4" style="font-size:.8125rem; color:var(--text-secondary);">
                            {{ $packing->created_at->format('d M Y, h:i A') }}
                        </p>
                    </div>
                    <div class="timeline-item">
                        ...
                        <p class="mb-0 ps-4" style="font-size:.8125rem; color:var(--text-secondary);">
                            {{ $packing->updated_at->format('d M Y, h:i A') }}
                        </p>
                    </div>
                </div>
            </div>
