                ...
                <table class="table table-hover mb-0">
                    ...
                    <tfoot>
                        ...
                        <tr>
                            ...
                            <th class="text-end">{{ number_format($sale->discount_amount, 2) }}</th>
                        </tr>
                        <tr>
                            <th colspan="7" class="text-end">Net Amount:</th>
                            <th class="text-end">{{ number_format($sale->net_amount, 2) }}</th>
                        </tr>
                    </tfoot>
                </table>
            </div>
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <th class="text-end">{{ number_format($sale->transactions->sum('amount'), 2) }}</th>
                            </tr>
                            <tr>
