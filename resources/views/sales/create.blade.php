            ...
            <form id="sale-form" action="{{ route('sales.store') }}" method="POST">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-3">
                        ...
                        <input type="date" name="sale_date" id="sale_date" class="form-control" required value="{{ now()->format('Y-m-d') }}">
                    </div>
                </div>
    ...
    function addProduct() {
        ...
        let newRow = `
            <tr data-product-id="${productId}">
                ...
                <td>
                    <input type="number" step="0.01" name="sale_items[${saleItemIndex}][sale_price]" class="form-control sale_price" required min="0" value="0.00" readonly>
                </td>
                <td>
