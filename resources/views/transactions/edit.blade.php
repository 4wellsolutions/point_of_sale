            ...
            <form action="{{ route('transactions.update', $transaction->id) }}" method="POST" id="transactionForm">
                ...
                <div class="mb-3">
                    ...
                    <select name="transactionable_type" id="transactionable_type"
                        ...
                        <option value="customer" {{ (old('transactionable_type', class_basename($transaction->transactionable_type)) == 'Customer') ? 'selected' : '' }}>Customer
                        </option>
                        <option value="vendor" {{ (old('transactionable_type', class_basename($transaction->transactionable_type)) == 'Vendor') ? 'selected' : '' }}>Vendor
                        </option>
                    </select>
                ...
                <div class="mb-3" id="transactionable_select_container" style="display: none;">
                    ...
                    <select name="transactionable_id" id="transactionable_id"
                        ...
                        @if(old('transactionable_type', class_basename($transaction->transactionable_type)) == 'Customer')
                            <option value="{{ $transaction->transactionable->id }}" selected>
                                {{ $transaction->transactionable->name }}</option>
