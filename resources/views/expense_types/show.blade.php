    ...
    <div class="detail-header mb-4">
        <div class="d-flex justify-content-between align-items-start flex-wrap gap-3">
            <div class="d-flex align-items-center gap-3">
                ...
                <div>
                    <h2 class="mb-1" style="font-weight:700; font-size:1.5rem;">{{ $expenseType->name }}</h2>
                    <span class="detail-id-badge">ID #{{ $expenseType->id }}</span>
                </div>
            </div>
            <div class="d-flex gap-2">
                ...
                <a href="{{ route('expense-types.index') }}" class="btn btn-outline-secondary btn-sm">
        ...
        <div class="col-lg-8">
            <div class="card">
                <div class="card-header d-flex align-items-center gap-2">
                    ...
                    <h3 class="card-title mb-0">Expense Type Information</h3>
                </div>
                ...
                <div class="card-body">
                    <div class="timeline-item mb-3">
                        ...
                        <p class="mb-0 ps-4" style="font-size:.8125rem; color:var(--text-secondary);">
                            {{ $expenseType->created_at->format('d M Y, h:i A') }}
                        </p>
                    </div>
                    <div class="timeline-item">
                        ...
                        <p class="mb-0 ps-4" style="font-size:.8125rem; color:var(--text-secondary);">
                            {{ $expenseType->updated_at->format('d M Y, h:i A') }}
                        </p>
                    </div>
                </div>
            </div>
