        ...
        <div class="card-body">
            <form action="{{ route('sales-returns.store') }}" method="POST">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="qty_returned" class="form-control" required min="1" value="{{ old('qty_returned') }}">
                </div>
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" step="0.01" name="refund_amount" class="form-control" required min="0" value="{{ old('refund_amount') }}">
                </div>
