...
@section('page_title', 'Stock Adjustment Details')
    ...
    <div class="detail-header mb-4">
        <div class="d-flex justify-content-between align-items-start flex-wrap gap-3">
            <div class="d-flex align-items-center gap-3">
                <div class="detail-icon-wrapper" style="background:linear-gradient(135deg,#8b5cf6,#7c3aed);">
                ...
                <div>
                    ...
                    <div class="d-flex align-items-center gap-2 flex-wrap">
                        @if($stockAdjustment->adjustment_type == 'addition')
                            <span class="badge bg-success"><i class="fas fa-plus"
                                    style="font-size:.5rem;vertical-align:middle;margin-right:3px;"></i>Addition</span>
                        @else
                            <span class="badge bg-danger"><i class="fas fa-minus"
                                    style="font-size:.5rem;vertical-align:middle;margin-right:3px;"></i>Subtraction</span>
                        @endif
                        <span
                            class="detail-id-badge">{{ \Carbon\Carbon::parse($stockAdjustment->adjustment_date)->format('d M Y') }}</span>
                    </div>
                </div>
            </div>
        ...
        <div class="col-lg-8">
            ...
            <div class="card mb-4">
                <div class="card-header d-flex align-items-center gap-2">
                    ...
                    <h3 class="card-title mb-0">Adjustment Information</h3>
                </div>
                <div class="card-body p-0">
                    <div class="row g-0">
                        <div class="col-sm-6">
                            <div class="detail-row">
                                <span class="detail-label"><i class="fas fa-hashtag"></i> Adjustment ID</span>
                                <span class="detail-value font-monospace">#{{ $stockAdjustment->id }}</span>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="detail-row">
                                <span class="detail-label"><i class="fas fa-truck-loading"></i> Purchase ID</span>
                                <span
                                    class="detail-value font-monospace">#{{ $stockAdjustment->purchase_item_id ?? '—' }}</span>
                            </div>
                        </div>
                        <div class="col-sm-6">
                            <div class="detail-row">
                                <span class="detail-label"><i class="fas fa-exchange-alt"></i> Type</span>
                        ...
                        <div class="col-sm-6">
                            <div class="detail-row">
                                ...
                                <span
                                    class="detail-value">{{ \Carbon\Carbon::parse($stockAdjustment->adjustment_date)->format('d M Y') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-12">
                            <div class="stat-tile" style="border-right:none;">
                                <div class="stat-tile-icon"
                                    style="background:{{ $stockAdjustment->adjustment_type == 'addition' ? 'rgba(16,185,129,.1)' : 'rgba(239,68,68,.1)' }}; color:{{ $stockAdjustment->adjustment_type == 'addition' ? '#10b981' : '#ef4444' }};">
                                    <i
