...
$query->whereDate('booking_date', '<=', $request->date_to);
    ...
    DB::commit();
    return response()->json(['success' => true, 'message' => 'Order Booking created successfully', 'redirect' =>
    ...
    DB::commit();
    return response()->json(['success' => true, 'message' => 'Order Booking updated successfully', 'redirect' =>
    route('bookings.index')]);
    } catch (\Exception $e) {
    DB::rollBack();
    return response()->json(['success' => false, 'message' => $e->getMessage()], 500);
    ...
    */
    ...
    return response()->json(['success' => false, 'message' => 'This booking has already been converted to a sale.'],
    422);
    }
